...
EDITORIAL = (
    API_BASE
    + "widgets/ard/editorials/{id}?pageNumber={page}&pageSize={page_size}&embedded=true"
)
GROUPING = API_BASE + "pages/ard/grouping/{id}?embedded=true"
ASSET = (
    API_BASE
    + "widgets/ard/asset/{id}?pageNumber={page}&pageSize={page_size}&embedded=true&seasoned=false&seasonNumber=&withAudiodescription=false&withOriginalWithSubtitle=false&withOriginalversion=false&single=false"
)
